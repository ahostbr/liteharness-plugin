...
.gallery-card {
  ...
  box-shadow:
    ...
    /* 主阴影，软且长 */ 0 6px 18px -6px rgba(29, 29, 31, 0.06); /* 第二层近光，制造浮感 */
...
.gallery-canvas {
  ...
  transform: perspective(2400px) rotateX(14deg) /* 向后倾 */ rotateY(-10deg) /* 向左转 */
...
- 完整实现样本：`hero-animation-v5.html`（local project file — see the showcases/ directory in this skill）
