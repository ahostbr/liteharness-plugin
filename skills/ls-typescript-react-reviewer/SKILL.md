...
description: Use when reviewing TypeScript or React code for quality, anti-patterns, type safety, or architectural problems. Triggers on 'review this React code', 'code review', 'check for anti-patterns', 'review PR', 'React architecture review', 'find code smells'. Covers React 19 patterns, useEffect abuse, state management.
---
